...
with col1:
    st.title("BHEL: LinkedIn Sentiment Analysis")
with col2:
...
def is_valid_linkedin_url(url):
    linkedin_pattern = r"^(https?:\/\/)?(www\.)?linkedin\.com\/(company|in)\/[\w-]+(\/posts\/.*)?\/?$"
...
with col1:
    st.markdown("<b>Enter / Paste LinkedIn Profile URL:</b>", unsafe_allow_html=True)
with col2:
